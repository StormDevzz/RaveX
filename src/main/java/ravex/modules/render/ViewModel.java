...
/**
 * ViewModel — полная кастомизация положения рук в игре.
 * Параметры применяются через MixinItemInHandRenderer.
 */
public class ViewModel extends Module {
    ...
    private ViewModel() {
        ...
        addParameter(mainY);
        addParameter(mainZ);
        addParameter(mainRotX);
        addParameter(mainRotY);
        ...
        addParameter(offY);
        addParameter(offZ);
        addParameter(offRotX);
        addParameter(offRotY);
