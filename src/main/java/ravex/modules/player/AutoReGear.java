...
public class AutoReGear extends Module {
    ...
    static {
        try {
            nativeLibLoaded = NativeLoader.loadLibrary("ravex_autoregear");
        } catch (UnsatisfiedLinkError e) {
            System.err.println("[AutoReGear JNI] Failed to load native library: " + e.getMessage());
        }
    }
    ...
    private AutoReGear() {
        super("AutoReGear", Category.PLAYER);
