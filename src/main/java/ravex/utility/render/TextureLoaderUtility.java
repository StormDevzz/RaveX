...
public class TextureLoaderUtility {
    ...
    @Nullable public static Identifier getPaletteTexture() {
        ...
        try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream(resourcePath)) {
            ...
            MinecraftWrapper.getWrapper().getTextureManager().register(PALETTE, tex);
    ...
    @Nullable public static Identifier getSettingsWhiteTexture() {
        if (!loaded.containsKey(SETTINGS_WHITE)) {
            ...
            try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream(CLASSPATH_PREFIX + "settings.png")) {
                ...
                image = downscaleTo(image, ICON_SIZE);
                AbstractTexture tex = createLinearTexture(image);
                MinecraftWrapper.getWrapper().getTextureManager().register(SETTINGS_WHITE, tex);
    ...
    @Nullable private static Identifier makeWhiteCopy(Identifier sourceId, Identifier targetId, String name) {
        try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream(CLASSPATH_PREFIX + name + ".png")) {
            ...
            image = downscaleTo(image, ICON_SIZE);
            AbstractTexture tex = createLinearTexture(image);
            MinecraftWrapper.getWrapper().getTextureManager().register(targetId, tex);
    ...
    @Nullable public static Identifier getCircleWhiteTexture() {
        if (!loaded.containsKey(CIRCLE_WHITE)) {
            ...
            try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream(CLASSPATH_PREFIX + "circle.png")) {
                ...
                image = downscaleTo(image, ICON_SIZE);
                AbstractTexture tex = createLinearTexture(image);
                MinecraftWrapper.getWrapper().getTextureManager().register(CIRCLE_WHITE, tex);
    ...
    public static Identifier getTrackWhiteTexture() {
        if (!loaded.containsKey(TRACK)) {
            ...
            AbstractTexture tex = createLinearTexture(image);
            MinecraftWrapper.getWrapper().getTextureManager().register(TRACK, tex);
    ...
    public static Identifier getSolidCircleTexture() {
        if (!loaded.containsKey(SOLID_CIRCLE)) {
            ...
            AbstractTexture tex = createLinearTexture(image);
            MinecraftWrapper.getWrapper().getTextureManager().register(SOLID_CIRCLE, tex);
    ...
    @Nullable public static Identifier getSwitcherTexture() {
        if (!loaded.containsKey(SWITCHER)) {
            try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream(CLASSPATH_PREFIX + "switcher.png")) {
                ...
                image = downscaleTo(image, ICON_SIZE);
                AbstractTexture tex = createLinearTexture(image);
                MinecraftWrapper.getWrapper().getTextureManager().register(SWITCHER, tex);
    ...
    @Nullable public static Identifier getParticleTexture(String name, int color) {
        ...
        try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream(resPath)) {
            ...
            AbstractTexture tex = createLinearTexture(image);
            MinecraftWrapper.getWrapper().getTextureManager().register(tintedId, tex);
    ...
    public static void preloadAll() {
        ...
        try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream("/assets/ravex/textures/marker.png")) {
            if (stream != null) {
                NativeImage image = NativeImage.read(stream);
                AbstractTexture tex = createLinearTexture(image);
                MinecraftWrapper.getWrapper().getTextureManager().register(MARKER, tex);
    ...
    private static boolean ensureModuleIcon(Identifier guiId, String fileName) {
        ...
        try (InputStream stream = TextureLoaderUtility.class.getResourceAsStream(resourcePath)) {
            ...
            AbstractTexture tex = createLinearTexture(image);
            MinecraftWrapper.getWrapper().getTextureManager().register(guiId, tex);
