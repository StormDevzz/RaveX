...
Java_ravex_modules_combat_AnchorAura_nativeCalculateAnchorAura(
    ...
    jboolean alwaysConsiderDurability,
    jdouble armorDurabilityThreshold
) {
    ...
    AnchorAuraResult result = AnchorAuraMath::findBestAnchorPlace(
        ...
        antiSuicideMinHp,
        predictTicks,
        (alwaysConsiderDurability == JNI_TRUE),
