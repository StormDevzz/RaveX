...
public class ClickGUI extends Screen {
    ...
    private void renderSearchBar(GuiGraphics graphics, int mouseX, int mouseY) {
        ...
        if (searchText.isEmpty() && !searchFocused) {
            FontRenderUtility.drawString(graphics, "Search...", barX + textOffset, textY, 0xFF888888, true);
        } else {
            FontRenderUtility.drawString(graphics, searchText, barX + textOffset, textY, 0xFFFFFFFF, true);
            if (searchFocused) {
        ...
        if (!searchQuery.isEmpty()) {
            ...
            if (resultCount > 0) {
                ...
                FontRenderUtility.drawString(graphics, countText, barX + barW - cw - 8, textY, 0xFFFFFFFF, true);
            }
        }
    }
