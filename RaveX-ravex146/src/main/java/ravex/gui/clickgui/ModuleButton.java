...
public class ModuleButton {
    ...
    public void render(GuiGraphics graphics, int x, int y, int width, int mouseX, int mouseY, int[] currentYOut, String searchQuery) {
        ...
        int textColor = hovered ? lerpColor(0xFFFFFFFF, 0xFFFFFFFF, enableAnim) : baseColor;
        ...
        if (hasParams) {
            ...
            if (settingsTex != null) {
                ...
                FontRenderUtility.drawString(graphics, FontRenderUtility.FontType.VANILLA, indicator, x + width - 12, textY, 0xFFFFFFFF, true);
            }
        }
        ...
        if (hasParams) {
            ...
            if (expandAnim > 0.01f) {
                ...
                if (maxScroll > 0) {
                    ...
                    graphics.fill(sbX, sbY, sbX + 2, sbY + sbH, 0x15FFFFFF);
